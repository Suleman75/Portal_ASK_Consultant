...
$status=selectData("case_status","enabled=1");
...
?>
    ...
    <label>ASK Email:</label><br><input class="form-control form-control-lg" type="text" name="ask_email" value="<?php echo $rows['ask_email'] ?>"><br>
    ...
    <label>Case Status 1:</label><br><select name="case_status_2" class="form-control form-control-lg">
        <?php
            foreach($status as $rows1)
            {
